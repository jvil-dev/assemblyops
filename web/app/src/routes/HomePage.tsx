  ...
  return (
    <main className="mx-auto flex max-w-[36rem] flex-col gap-xl px-screen py-xxl pb-[env(safe-area-inset-bottom)]">
      ...
      <button
        ...
        className="min-h-btn-sm self-start rounded-btn border border-control px-l text-body font-medium text-ink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring"
      >
        Sign out
      </button>
    </main>
